	...
	const portfolioItems: PortfolioItem[] = [
		{
			...
			description:
				"Entwicklung konstruktiver Feedbackkulturen und -methoden (z.B. Critical Response Process) zur Stärkung von Lehr- und Lernprozessen.",
		...
		},
		{
			...
			description:
				"Gestaltung fairer, transparenter und förderlicher Prüfungsformate und Bewertungsstrategien für künstlerische Leistungen.",
		...
		{
			title: "Kooperative Lehrformate",
			description:
				"Konzeption und Umsetzung gemeinsamer Lehrsettings wie Co- und Teamteaching zur Bündelung von Expertise und Förderung von Lernchancen.",
		...
		{
			title: "Kollegialer Austausch & Beratung",
			description:
				"Etablierung von Formaten wie kollegiale Beratung und Hospitation zur gegenseitigen Unterstützung und Professionalisierung im Kollegium.",
		...
		},
		{
			...
			description:
				"Nutzung von Lern- und Lehrportfolios zur Dokumentation, kritischen Reflexion und gezielten Weiterentwicklung individueller (Lehr-)Profile.",
		...
		{
			title: "Lehrcoaching & Didaktische Beratung",
			description:
				"Individuelle, prozessorientierte Begleitung für Lehrende sowie strategische Beratung bei der Planung und Einführung musik(hoch)schuldidaktischer Angebote.",
			...
			<div class="container mx-auto px-4 py-8 lg:py-16">
				...
				<div class="flex flex-col items-center justify-center mb-8 lg:mb-12">
					...
					<p class="mt-3 text-center text-neutral-600 max-w-2xl">
						Mit praxisorientierten Workshops, individueller Begleitung und strategischer Beratung unterstütze ich Musikschulen, Musikhochschulen sowie ihre Lehrenden und Lernenden.
					</p>
				</div>
