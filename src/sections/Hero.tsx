...
const Hero: Component = () => {
	...
	return (
		...
		>
			<div class="flex flex-col-reverse xl:flex-row items-center justify-center container mx-auto px-4">
				{/* Left Column (Text Content) */}
				<div class="flex flex-col justify-center xl:w-1/2 space-y-2 text-center xl:text-left mt-8 xl:mt-12">
					...
					<div class="flex items-center justify-center xl:justify-start space-x-6 py-4">
						<button
							type="button"
				...
				<div class="flex justify-center items-center w-full xl:w-1/2">
					...
					<div class="w-5/6 aspect-square max-w-xs sm:max-w-sm md:w-96 md:h-96 xl:w-128 xl:h-128 lg:max-w-none">
						<img
							// Placeholder B&W portrait from Unsplash
							src="portrait.jpg"
							alt="Portrait Maria Waloschek"
							class="w-full h-full object-cover rounded-full border-[12px] xl:border-[16px] border-white shadow-2xl"
						/>
					</div>
				</div>
			</div>
